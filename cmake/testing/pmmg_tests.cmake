IF( BUILD_TESTING )
  ...
  foreach( MESH cube-unit-dual_density cube-unit-int_sphere )
    foreach( NP 1 2 4 6 8 )
      add_test( NAME ${MESH}-${NP}
        COMMAND ${MPIEXEC} -oversubscribe ${MPIEXEC_NUMPROC_FLAG} ${NP} $<TARGET_FILE:${PROJECT_NAME}>
  ...
  FOREACH ( test_idx RANGE ${nbTests} )
    ...
    FOREACH( NP 1 2 6 )
      ADD_TEST ( NAME ${test_name}-${NP} COMMAND  ${MPIEXEC} -oversubscribe ${MPIEXEC_NUMPROC_FLAG} ${NP}
